...
-- -----------------------------------------------------
-- Table `legato_db`.`album`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `legato_db`.`album` ;

CREATE TABLE IF NOT EXISTS `legato_db`.`album` (
...
CREATE TABLE IF NOT EXISTS `legato_db`.`tracks` (
  ...
  `file_path_md5_hash` CHAR(32) NOT NULL,
  `file_md5_hash` CHAR(32) NOT NULL,
  ...
  UNIQUE INDEX `file_path_md5_hash_UNIQUE` (`file_path_md5_hash` ASC) VISIBLE,
  CONSTRAINT `fk_tracks_albums_album_id`
    FOREIGN KEY (`album_id`)
    REFERENCES `legato_db`.`album` (`album_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
